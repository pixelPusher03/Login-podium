#!/bin/bash  
 ...
 python3 encrypt.py ${key:0:1} ${key:1:1} ${key:2:1} ${key:3:1} ${key:4:1} $password 
 echo -e "$(tput setaf 3)" 
 ...
 retrived=`cat temp1` 
 rm temp1 
 python3 encrypt.py ${key:0:1} ${key:1:1} ${key:2:1} ${key:3:1} ${key:4:1} $retrived 
 fi 
 echo -e "$(tput setaf 3)" 
